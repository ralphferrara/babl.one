...
//||=-=-=-=-=-=-=-=-=--=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-||*/
      ...
      import { RequestData }                                            from '../../interfaces/server/request.data.js';
      import { UploadFile }                                             from "../../interfaces/server/upload.file.js";
      ...
      export default class MultipartParser {
            ...
            constructor(contentTypeHeader: string | undefined, maximumFileSize? : number) {
                  ...
                  this.maximumFileSize = maximumFileSize || this.maximumFileSize;
            }
